    ...
    <div>
      ...
      <nav className="navbar navbar-light bg-light static-top">
        <div className="container">
          <a className="navbar-brand" href="#!">Schedule My Email</a>
          ...
          <div className="row justify-content-center">
            <div className="col-xl-6">
              <div className="text-center text-white">
                {/* Page heading*/}
                <h1 className="mb-5">Schedule sending yourself an Email in the future!</h1>
                {/* Signup form*/}
                {/* * * * * * * * * * * * * * * **/}
                ...
                <form className="form-subscribe" id="contactForm" data-sb-form-api-token="API_TOKEN">
                  ...
                  <div className="row">
                    <div className="col">
                      <input className="form-control form-control-lg" id="emailAddress" type="email" placeholder="Email Address" required />
                      <br />
                      <textarea class="form-control" id="exampleFormControlTextarea3" rows="7" required placeholder="Email Content"></textarea>
                      <br />
                      <input className="form-control form-control-lg" id="datetime" required type="datetime-local"  />
          ...
          <div className="row">
            <div className="col-lg-4">
              <div className="features-icons-item mx-auto mb-5 mb-lg-0 mb-lg-3">
                ...
                <p className="lead mb-0">This tool is automated to send you your personalized emails at just the right time.</p>
              </div>
            </div>
            <div className="col-lg-4">
              <div className="features-icons-item mx-auto mb-5 mb-lg-0 mb-lg-3">
                ...
                <p className="lead mb-0">You can send as many emails ad you like and receive them on time.</p>
              </div>
            </div>
            <div className="col-lg-4">
              <div className="features-icons-item mx-auto mb-0 mb-lg-3">
                ...
                <h3>Easy to Use</h3>
                <p className="lead mb-0">Simply add your details and send the emails. Easy peasy!</p>
              </div>
            </div>
          </div>
        </div>
